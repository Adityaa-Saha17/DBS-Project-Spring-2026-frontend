...
export default function Cart() {
    ...
    const checkout = async () => {
        try {
            ...
            alert("Order failed: " + (err.response?.data || "Internal Server Error"));
        }
    };
            ...
            {items.length === 0 ? (
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-material h-fit sticky top-24">
                        ...
                        <button
                            onClick={checkout}
                            className="w-full flex items-center justify-center gap-2 bg-primary text-white p-4 rounded-2xl font-bold hover:opacity-90 transition-all shadow-lg shadow-indigo-200"
                        >
